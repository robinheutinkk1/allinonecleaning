...
export const metadata: Metadata = {
  ...
  description: "Dashboard van All in One Vastgoedonderhoud: aanvragen, projecten, reviews en instellingen beheren.",
    ...
    <div className="flex min-h-screen items-center justify-center bg-navy-950 p-6">
      <div className="w-full max-w-sm">
        <div className="mb-8 flex flex-col items-center text-center">
          <Logo inverted href={null} className="h-28" />
        ...
        <div className="rounded-3xl bg-white p-6 shadow-lift sm:p-8">
          ...
          <p className="mt-1 text-sm text-navy-500">Alleen voor medewerkers van All in One Vastgoedonderhoud.</p>
          <div className="mt-6">
