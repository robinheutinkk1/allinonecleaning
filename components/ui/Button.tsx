...
const variants: Record<Variant, string> = {
  primary:
    "bg-gold-500 text-navy-950 shadow-[0_8px_24px_-8px_rgb(217_162_58_/_0.6)] hover:bg-gold-400 hover:shadow-[0_12px_32px_-8px_rgb(217_162_58_/_0.7)] hover:-translate-y-0.5",
  secondary:
