            ...
            <StaggerItem key={s.n} className="relative">
              <div className="flex items-center gap-4 lg:flex-col lg:items-start">
                <span className="relative flex size-14 shrink-0 items-center justify-center rounded-2xl bg-white/10 ring-1 ring-white/15 backdrop-blur">
                  <s.icon className="size-6 text-aqua-300" aria-hidden />
                  <span className="absolute -right-2 -top-2 rounded-full bg-aqua-500 px-2 py-0.5 font-display text-[11px] font-bold text-white">{s.n}</span>
                </span>
