    ...
    <article className="flex flex-col overflow-hidden rounded-3xl bg-white shadow-soft ring-1 ring-navy-100">
      ...
      <div className="flex flex-1 flex-col p-6">
        <div className="flex flex-wrap items-center gap-2 text-xs font-semibold">
          <span className="rounded-full bg-gold-100 px-3 py-1 text-gold-800">{project.serviceLabel}</span>
        ...
        {project.result && (
          <p className="mt-4 flex items-start gap-2 rounded-2xl bg-gold-50 p-3 text-sm text-navy-800">
